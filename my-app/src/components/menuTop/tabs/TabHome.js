...
import { faCaretDown,faPause, faPlay, faShoppingCart, faCartArrowDown, faExchange, faTimes, faArrowDown, faArrowUp,
					...
					<div className="nav-item">
						<div className="d-flex nav-item__main flex-column">
							...
							<div className="d-flex flex-column">
								...
								<input type="range" onChange={this.testingSpeed}  className="custom-range" id="customRange1" 	defaultValue={this.state.testingSpeed.currentSpeed} 	min={this.state.testingSpeed.min} max={this.state.testingSpeed.max}  />
